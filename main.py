    ...
    TabbedPanelItem:
        ...
        GridLayout:
            ...
            Label:
                ...
                text: 'Aghasty GD - 2022'
            RstDocument:
                font_size: 24
                text:
                    '\\n'.join(("=====","Ajuda", "=====", "**Um App para Consulta de Cotação de Moedas**:","Nele você pode consultar as suas moedas cripto para USD. Espero que curta e se puder, dê uma olhada em outros projetos interessantes no meu github: **AghastyGD**"))
...
class ConverterCriptoApp(App):
    def build(self):
        return Painel()

if __name__ == '__main__':
    ConverterCriptoApp().run()
